  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-10">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md text-center">
        ...
        <form className="space-y-5 mb-8">
          <div className="text-left">
            ...
            <input
              ...
              id="name"
              name="name"
              defaultValue="User Name" // Placeholder for current user name
          ...
          <div className="text-left">
            ...
            <input
              ...
              id="email"
              name="email"
              defaultValue="user@example.com" // Placeholder for current user email
              className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          <div className="text-left">
        ...
        <button
          type="button"
          className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline w-full transition duration-200 ease-in-out"
        >
          Delete Account
        </button>

        <p className="mt-6 text-gray-600 text-sm">
          <Link href="/" className="text-blue-600 hover:underline">Back to Todo List</Link>
        </p>
      </div>
    </div>
  );
